...
{
	if (((m_CurrentLocation[1] - 1) >= 0) && ((m_CurrentLocation[1] + 1) < (m_CurrentLevel.size() + 1)) && ((m_CurrentLocation[0] - 1) >= 0) && ((m_CurrentLocation[1] + 1) < (m_CurrentLevel[0].size() + 1)))
	{
		// North
		if (m_Chromosomes[_i][_j] == 0)
		{
			if (m_CurrentLevel[m_CurrentLocation[1] + 1][m_CurrentLocation[0]] == 3)
			{
				m_ChromosomeFinished = true;
			}
			if (m_CurrentLevel[m_CurrentLocation[1] + 1][m_CurrentLocation[0]] == 0)
			{
		...
		{
			if (m_CurrentLevel[m_CurrentLocation[1] + 1][m_CurrentLocation[0] + 1] == 3)
			{
				m_ChromosomeFinished = true;
			}
			if (m_CurrentLevel[m_CurrentLocation[1] + 1][m_CurrentLocation[0] + 1] == 0)
			{
				m_CurrentLocation[1] += 1;
		...
		{
			if (m_CurrentLevel[m_CurrentLocation[1]][m_CurrentLocation[0] + 1] == 3)
			{
				m_ChromosomeFinished = true;
			}
			if (m_CurrentLevel[m_CurrentLocation[1]][m_CurrentLocation[0] + 1] == 0)
			{
				m_CurrentLocation[0] += 1;
			}
		}
